...
<template>
  <header class="sticky top-0 z-50 backdrop-blur-md bg-white/80 dark:bg-neutral-950/80 border-b border-neutral-200 dark:border-neutral-800">
    <nav class="max-w-3xl mx-auto px-6 h-16 flex items-center justify-between">
      ...
      <div class="flex items-center gap-6">
        ...
        >
          <svg v-if="theme.isDark" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-5 h-5">
